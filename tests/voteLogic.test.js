...
test('computeRankedVoteSummary counts palette choices', () => {
  const summary = computeRankedVoteSummary([
    ['v1', { name: 'Alexis', paletteKey: 'palette1', ranking: { logo1: 1, logo2: 2, logo3: 3, logo4: 4, logo5: 5, logo6: 6 }, ts: 200 }],
    ['v2', { name: 'Camille', paletteKey: 'palette2', ranking: { logo1: 2, logo2: 1, logo3: 3, logo4: 4, logo5: 5, logo6: 6 }, ts: 100 }],
    ['v3', { name: 'Dana', paletteKey: 'palette1', ranking: { logo1: 3, logo2: 2, logo3: 1, logo4: 4, logo5: 5, logo6: 6 }, ts: 300 }],
  ]);
...
test('computeRankedVoteSummary aggregates logo rank scores', () => {
  ...
  assert.deepEqual(summary.logos.logo1.rankCounts, { 1: 1, 2: 1, 3: 0, 4: 0, 5: 0, 6: 0 });
